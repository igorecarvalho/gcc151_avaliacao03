...
from nlputils.lexical.preprocessing import Preprocessing
...
class Semantics:
    ...
    def __init__(self, path="../data/trainset/", trained_path="", trainset=0.8, language='../models/pt_core_news_sm-2.1.0'):
        """
        ...
        self.spacy_nlp = spacy.load(language)
